...
I used raster and vector data and spatial analysis tools to identify where these ranges overlapped to isolate suitable habitat.
...
Average annual sea surface temperature (SST) from the years
2008 to 2012 was used to characterize the average sea surface temperature within the region. The data was originally generated from
...
Maritime boundaries were designated using Exclusive Economic
